...
const staticRecords = [
  { id: 1, amount: 50, category: "Food", date: "2025-08-01" },
  { id: 2, amount: 30, category: "Transport", date: "2025-08-02" },
  { id: 3, amount: 70, category: "Entertainment", date: "2025-08-03" },
  // add more static records here as needed
];

const RecordChart = () => {
  // Simulate no error and static records data
