        ...
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <div>
            ...
            >
              ...
              <span className="text-sm sm:text-base md:text-lg lg:text-xl font-bold bg-gradient-to-r from-emerald-600 via-green-500 to-teal-500 bg-clip-text text-transparent">
                <span className="hidden sm:inline">GebinaWechi AI </span>
                <span className="sm:hidden">GebinaWechi</span>
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-1 sm:space-x-2">
            ...
            <button
              ...
              className="md:hidden p-1.5 sm:p-2 rounded-lg sm:rounded-xl text-gray-600 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50/50 dark:hover:bg-emerald-900/20 transition-all duration-200 active:scale-95 cursor-pointer"
